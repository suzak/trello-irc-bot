...
_.extend(Stream.prototype, {
    connect: function () {
        ...
        promise.then(_.bind(function (body) {
    ...
    openWebSocket: function (id) { // private
        ...
        ws.on('open', _.bind(this.onOpen, this));
        ws.on('close', _.bind(this.onClose, this));
        ws.on('message', _.bind(this.onMessage, this));
    },
    ...
    onMessage: function (message, flags) { // private
        ...
        if (data[1] == 1) {
            ...
            pinged.then(_.bind(this.emit, this, 'connect'));
        } else if (data[1] == 2) {
            this.send(2);
        } else if (data[1] == 4) {
